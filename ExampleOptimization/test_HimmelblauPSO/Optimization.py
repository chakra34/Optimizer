...
# =====================================================      
    ...
    with open("{}/points1.txt".format(self.root),'a') as points:
      points.write('2 head \n')
      points.write('Generation 1 \n') 
      points.write('index ')
      for i in range(self.dimension):
        points.write('{}_pos '.format(i+1))
      points.write('\n')  
      np.savetxt(points, points2print, delimiter=' ', newline='\n')  

    with open("{}/pBest1.txt".format(self.root),'a') as posb:
      posb.write('2 head \n')
    ...
    with open("{}/velocities1.txt".format(self.root),'a') as velos:
      velos.write('2 head \n')
    ...
    with open("{}/gBest1.txt".format(self.root),'a') as posg:
      posg.write('2 head \n')
...
#=============== Basic PSO ================================ #
    ...
    with open("{}/points{}.txt".format(self.root,self.generation+1),'a') as points:
      points.write('2 head \n')
      points.write('Generation 1 \n') 
      points.write('index ')
      for i in range(self.dimension):
    ...
    with open("{}/pBest{}.txt".format(self.root,self.generation+1),'a') as posb:
      posb.write('2 head \n')
      posb.write('Generation 1 \n') 
      posb.write('index ')
      for i in range(self.dimension):
    ...
    with open("{}/velocities{}.txt".format(self.root,self.generation+1),'a') as velos:
      velos.write('2 head \n')
      velos.write('Generation 1 \n') 
      velos.write('index ')
      for i in range(self.dimension):
    ...
    with open("{}/gBest{}.txt".format(self.root,self.generation+1),'a') as posg:
      posg.write('2 head \n')
      posg.write('Generation 1 \n') 
      for i in range(self.dimension):
        posg.write('{}_pos '.format(i+1))
...
# =====================================================
    ...
    while list(self.locations.values())[history_best] > self.tolerance and self.cost() <= 500 \
          and np.logical_not(np.all(self.points == self.points[0,:])):
      self.generation += 1
      with open("{}/fitness_results.txt".format(self.root),'a') as fit:                                 #writing twice cost for the first round  
        fit.write('{} {}\n'.format(self.cost(),list(self.locations.values())[history_best]))
